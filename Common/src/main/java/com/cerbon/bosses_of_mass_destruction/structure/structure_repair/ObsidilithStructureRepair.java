...
public class ObsidilithStructureRepair implements StructureRepair{
    ...
    public void repairStructure(ServerLevel level, StructureStart structureStart) {
        ...
        Dispatcher.sendToClientsLoadingPos(new ObsidilithReviveS2CPacket(VecUtils.asVec3(topCenter).add(0.5, 0.5, 0.5)), level, VecUtils.asVec3(topCenter).add(0.5, 0.5, 0.5));
