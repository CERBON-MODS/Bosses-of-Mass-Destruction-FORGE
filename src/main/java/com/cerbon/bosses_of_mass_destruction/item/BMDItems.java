...
public class BMDItems {
    ...
    public static final RegistryObject<Item> SOUL_STAR = ITEMS.register("soul_star",
            () -> new SoulStarItem(new Item.Properties().tab(BMDCreativeModeTabs.BOSSES_OF_MASS_DESTRUCTION)));

    public static final RegistryObject<Item> ANCIENT_ANIMA = ITEMS.register("ancient_anima",
            () -> new MaterialItem(new Item.Properties().rarity(Rarity.RARE).tab(BMDCreativeModeTabs.BOSSES_OF_MASS_DESTRUCTION)));

    public static final RegistryObject<Item> BLAZING_EYE = ITEMS.register("blazing_eye",
            () -> new MaterialItem(new Item.Properties().rarity(Rarity.RARE).fireResistant().tab(BMDCreativeModeTabs.BOSSES_OF_MASS_DESTRUCTION)));
    ...
    public static final RegistryObject<Item> EARTHDIVE_SPEAR = ITEMS.register("earthdive_spear",
            () -> new EarthdiveSpear(new Item.Properties().fireResistant().durability(250).tab(BMDCreativeModeTabs.BOSSES_OF_MASS_DESTRUCTION)));
    ...
    public static final RegistryObject<Item> CRYSTAL_FRUIT = ITEMS.register("crystal_fruit",
            () -> new CrystalFruitItem(new Item.Properties().rarity(Rarity.RARE).fireResistant().food(BMDFoods.CRYSTAL_FRUIT).tab(BMDCreativeModeTabs.BOSSES_OF_MASS_DESTRUCTION)));
    ...
    public static final RegistryObject<Item> MOB_WARD = ITEMS.register("mob_ward",
            () -> new BlockItem(BMDBlocks.MOB_WARD.get(), new Item.Properties().tab(BMDCreativeModeTabs.BOSSES_OF_MASS_DESTRUCTION)));

    public static final RegistryObject<Item> MONOLITH_BLOCK = ITEMS.register("monolith_block",
            () -> new BlockItem(BMDBlocks.MONOLITH_BLOCK.get(), new Item.Properties().tab(BMDCreativeModeTabs.BOSSES_OF_MASS_DESTRUCTION)));

    public static final RegistryObject<Item> LEVITATION_BLOCK = ITEMS.register("levitation_block",
            () -> new BlockItem(BMDBlocks.LEVITATION_BLOCK.get(), new Item.Properties().tab(BMDCreativeModeTabs.BOSSES_OF_MASS_DESTRUCTION)));
    ...
    public static final RegistryObject<Item> VOID_LILY = ITEMS.register("void_lily",
            () -> new BlockItem(BMDBlocks.VOID_LILY_BLOCK.get(), new Item.Properties().tab(BMDCreativeModeTabs.BOSSES_OF_MASS_DESTRUCTION)));
